...
3. **Never delegate understanding** — Write: true 
 specific prompts, not vague instructions
4. **Parallel reads, sequential Write: true 
s** — Read-only tasks can run in parallel
...
3. DISPATCH workers (parallel for reads, sequential for Write: true 
s)
...
3. Never Write: true 
 "based on your findings, fix it" — prove YOU understood
